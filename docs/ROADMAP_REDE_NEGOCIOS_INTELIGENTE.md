# Roadmap — Rede de Negócios Inteligente
...
## B1-R.4 — Hub.IA Score e indicadores

Definir métricas reais, auditáveis e explicáveis para relacionamento, atendimento e desempenho. Nenhum score deve ser exibido antes da existência do contrato e da metodologia canônica.

## B1-R.5 — IA para descoberta e recomendação de parceiros

Usar sinais autorizados da Rede para apoiar descoberta e recomendação, sem automatizar decisões críticas nem expor dados entre tenants.

## B1-R.6 — Monitoramento e inteligência contínua da rede

Evoluir para acompanhamento contínuo de relacionamento, riscos e oportunidades, com controles de acesso, rastreabilidade e políticas de retenção.
