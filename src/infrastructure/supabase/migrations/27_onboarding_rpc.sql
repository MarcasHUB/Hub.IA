-- ==========================================
-- Migration 27: complete_onboarding RPC
-- Cria organização, perfil, segmentos e aceita convite atomicamente
-- Schema baseado nas colunas reais do banco de produção
-- ==========================================
